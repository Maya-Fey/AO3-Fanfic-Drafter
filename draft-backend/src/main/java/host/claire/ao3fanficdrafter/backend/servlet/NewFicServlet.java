...
public class NewFicServlet extends OuterServlet {
	...
	public void init(ServletConfig conf) {
		this.serv = (InnerServlet<IncomingPacket>) new InnerServletAuthenticationAdapter(ServletGlobalState.instance.getVerify(), new NewFicInnerServlet(ServletGlobalState.instance.getStorage()));
	}
