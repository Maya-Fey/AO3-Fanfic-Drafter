...
public class ReadServlet extends OuterServlet {
	...
	public void init(ServletConfig conf) {
		this.serv = (InnerServlet<IncomingPacket>) new InnerServletAuthenticationAdapter(ServletGlobalState.instance.getVerify(), new ReadFicInnerServlet(ServletGlobalState.instance.getStorage()));
	}
