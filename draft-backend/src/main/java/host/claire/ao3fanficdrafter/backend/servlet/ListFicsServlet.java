...
public class ListFicsServlet extends OuterServlet {
	...
	public void init(ServletConfig conf) {
		this.serv = (InnerServlet<IncomingPacket>) new InnerServletAuthenticationAdapter(ServletGlobalState.instance.getVerify(), new ListFicsInnerServlet(ServletGlobalState.instance.getStorage()));
	}
